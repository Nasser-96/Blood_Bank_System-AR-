CREATE DATABASE  IF NOT EXISTS `blood_bank` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `blood_bank`;
...
--
-- Table structure for table `acceptor_info`
--

DROP TABLE IF EXISTS `acceptor_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `acceptor_info` (
  `idacceptor` int NOT NULL AUTO_INCREMENT,
  ...
  `gender` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `blood_type` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  `number_of_blood_units` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `email` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`idacceptor`),
...
CREATE TABLE `donor_info` (
  `iddonor_info` int NOT NULL AUTO_INCREMENT,
  ...
  `phone_number` int DEFAULT NULL,
  `address` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `purpose_of_donation` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `email` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`iddonor_info`),
  UNIQUE KEY `email_UNIQUE` (`email`),
  UNIQUE KEY `card_id_UNIQUE` (`card_id`),
  UNIQUE KEY `phone_number_UNIQUE` (`phone_number`)
...
-- Dump completed on 2021-02-24 18:39:14
